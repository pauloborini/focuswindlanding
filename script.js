document.addEventListener('DOMContentLoaded', () => {
    const translations = {
        pt: {
            ...
            "page.download.title": "FocusWind | Download",
            "lang.label": "Idioma",
            ...
            "download.tagline": "Download",
            "download.title": "Baixe o FocusWind",
            "download.subtitle": "Escolha sua plataforma e comece agora.",
            "download.mac.title": "macOS",
            "download.mac.chip": "Disponível",
            "download.mac.desc": "Versão nativa com modo compacto e foco total.",
            "download.mac.cta": "Baixar .dmg",
            "download.win.title": "Windows",
            "download.win.chip": "Em breve",
            "download.win.desc": "Estamos finalizando a versão para Windows.",
            "download.win.cta": "Em desenvolvimento",
            "download.ios.title": "iOS",
            "download.ios.chip": "Em breve",
            "download.ios.desc": "Baixe pela App Store e sincronize com o desktop.",
            "download.ios.cta": "Em breve",
            "download.android.title": "Android",
            "download.android.chip": "Em breve",
            "download.android.desc": "Disponível no Google Play para foco contínuo.",
            "download.android.cta": "Em breve"
        },
        en: {
            ...
            "plan.premium.price": "R$ 6.90 / month",
            ...
            "plan.annual.price": "R$ 69.90 / year",
            ...
            "download.tagline": "Download",
            "download.title": "Download FocusWind",
            "download.subtitle": "Choose your platform and get started.",
            "download.mac.title": "macOS",
            "download.mac.chip": "Available",
            "download.mac.desc": "Native build with compact mode and focused flow.",
            "download.mac.cta": "Download .dmg",
            "download.win.title": "Windows",
            "download.win.chip": "Coming soon",
            "download.win.desc": "We are finishing the Windows version.",
            "download.win.cta": "In development",
            "download.ios.title": "iOS",
            "download.ios.chip": "Coming soon",
            "download.ios.desc": "Get it on the App Store and sync with desktop.",
            "download.ios.cta": "Coming soon",
            "download.android.title": "Android",
            "download.android.chip": "Coming soon",
            "download.android.desc": "Available on Google Play for continuous focus.",
            "download.android.cta": "Coming soon"
        }
    };
